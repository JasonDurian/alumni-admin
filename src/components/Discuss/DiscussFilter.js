  ...
  return (
    <Row gutter={24}>
      <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
        {getFieldDecorator('keywords', { initialValue: keywords })(<Search placeholder="Search Content" size="large" onSearch={handleSubmit} />)}
      </Col>
...
export default Form.create()(DiscussFilter)
